...
setoutdist(mpcobj,'Model', eye(2)*tf(0.05,[1 -1],'Ts',Ts_mpc) );
% Specifying the sample time of the Model predictive controller
mpcobj.Ts = Ts_mpc;
% Setting the upper and lower limits for the MV and OV
mpcobj.ManipulatedVariables = struct('Max',{1,1},'Min',{-1, -1},'MinECR',[0 0],'MaxECR',[0 0]);
mpcobj.OutputVariables = struct('Max',{0.1,1},'Min',{-0.1,-1},'MinECR',[1 1],'MaxECR',[1 1]);
